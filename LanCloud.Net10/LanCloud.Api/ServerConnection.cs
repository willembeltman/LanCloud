...
//    public async Task ITestApi_Test1(SendRequestDto ___sendRequest, CancellationToken ___ct)
//    {
...
//        }
//    }
//    public async IAsyncEnumerable<byte[]> ITestApi_Test2(InvokeRequestDto ___invokeRequest, CancellationToken ___ct)
//    {
//        if (___logger.IsEnabled(LogLevel.Trace))
...
//            yield return ITestApi_Test2_Serializer(response);
//        }
//    }
//    public async IAsyncEnumerable<byte[]> ITestApi_Test3(InvokeRequestDto ___invokeRequest, 
...
//        }
//    }
//    public async Task ITestApi_Test4(SendRequestDto ___sendRequest, string name, IAsyncEnumerable<string> test, IAsyncEnumerable<string> test2, CancellationToken ___ct)
//    {
//        if (___logger.IsEnabled(LogLevel.Trace))
...
//        }
//    }
//    public async IAsyncEnumerable<byte[]> ITestApi_Test5(InvokeRequestDto ___invokeRequest, string name, IAsyncEnumerable<string> test, IAsyncEnumerable<string> test2, CancellationToken ___ct)
//    {
//        if (___logger.IsEnabled(LogLevel.Trace))
...
//            yield return ITestApi_Test5_Serializer(response);
//        }
//        finally
//        {
...
//    public IAsyncEnumerable<byte[]> ITestApi_Test6(InvokeRequestDto ___invokeRequest, string name, IAsyncEnumerable<string> test, IAsyncEnumerable<string> test2, CancellationToken ___ct)
//    {
//        if (___logger.IsEnabled(LogLevel.Trace))
...
//        return ITestApi_Test6_Enumerator(responses, ___invokeRequest);
//    }

//    private async IAsyncEnumerable<byte[]> ITestApi_Test6_Enumerator(IAsyncEnumerable<string> responses, InvokeRequestDto ___invokeRequest)
//    {
//        try
//        {
//            await foreach (var response in responses)
...
//    }
//    public async IAsyncEnumerable<string> ITestApi_Test6_1_Enumerator(RoutingDto routing)
//    {
//        var remoteEnumerator = RegisterRemoteAsyncEnumerableArgument2(routing, 1);
//        await foreach (var data in remoteEnumerator)
//        {
//            yield return ITestApi_Test6_1_Deserializer(data);
//        }
//    }
//    public async IAsyncEnumerable<string> ITestApi_Test6_2_Enumerator(RoutingDto routing)
//    {
//        var remoteEnumerator = RegisterRemoteAsyncEnumerableArgument2(routing, 2);
//        await foreach (var data in remoteEnumerator)
//        {
//            yield return ITestApi_Test6_2_Deserializer(data);
//        }
//    }
