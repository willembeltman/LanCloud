...
public static class FileInfoDtoSpanSerializer
{
    public const ushort Magic = (ushort)0x4741;
    public const uint TypeId = 0xB8C30098;
    public const uint SchemaHash = 0x811C9DC5;

    [IsSpanSerializerWrite]
    public static void Write(this ref Span<byte> ___span, ref int ___offset, FileInfoDto value)
    {
    ...
    public static FileInfoDto ReadFileInfoDto(this ReadOnlySpan<byte> ___span, ref int ___offset)
    {
        ...
        var value = new FileInfoDto();
        return value;
    }

    [IsSpanSerializerLength]
    public static int Length(ref int ___offset, FileInfoDto value)
    {
        ___offset += 10;
        return ___offset;
    }
