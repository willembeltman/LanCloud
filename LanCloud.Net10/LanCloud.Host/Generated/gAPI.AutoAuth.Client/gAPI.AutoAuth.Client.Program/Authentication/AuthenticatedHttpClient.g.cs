      ...
      IAuthenticatedHttpClient
{
    ...
    private StateDto? OldState { get; set; }
    private StateDto? State;
    private DateTime StateLastUpdate;
    private Task<StateDto>? StateFetchTask;
    ...
    public async Task<StateDto> GetStateAsync(bool force = false, CancellationToken ct = default)
    {
    ...
    private async Task<StateDto> FetchStateAsync(CancellationToken ct)
    {
        try
        {
    ...
    private async Task UpdateStateDataInternal(StateDto value)
    {
    ...
    private static AuthenticationState GetAuthenticationState(StateDto state)
    {
        return state.User != null
    ...
    private static AuthenticationState CreateAuthenticationStateFromState(StateDto state)
    {
        var claims = new[]
        {
